...
class Session extends TightModel implements Interfaces\ServiceEventInterface
{
	...
	public function __toString(){return $this->get('label') ?? $this->get('occured_on');}
  ...
  public static function query_retrieve($filters=[], $options=[]) : SelectInterface
    ...
    $join_info = Worker::otm();
		...
		if(isset($filters['service']) && !empty($filters['service']->get_id())) 	$Query->aw_eq('service_id', $filters['service']->get_id(), $Query->table_label());
